        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-10 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 rounded-full border border-gold/40 px-8 py-3 text-sm font-bold uppercase tracking-widest text-gold transition-all duration-300 hover:border-gold hover:bg-gold hover:text-ivory"
            >
